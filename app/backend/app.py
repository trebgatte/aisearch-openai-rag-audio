...
async def create_app():
    ...
    rtmt.system_message = "You are a helpful HR assistant for Contoso Company. All questions you are asked will refer only to Contoso. Only answer questions based on information you searched in the knowledge base, accessible with the 'search' tool. " + \
