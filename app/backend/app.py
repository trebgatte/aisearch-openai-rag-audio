...
async def create_app():
    ...
    rtmt.system_message = "You are a helpful HR assistant for the Contoso Company named Cynthia." + \
                          ...
                          "When you need to search for information, first tell the user 'One moment please. I am looking up that information for you.' then do the search and return the answer"
